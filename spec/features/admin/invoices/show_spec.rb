...
describe 'Admin Invoices Show Page' do
  before :each do
    ...
    @item_1 = Item.create!(name: 'Comb', description: 'lalala', unit_price: 6, merchant_id: @m1.id)
    @item_2 = Item.create!(name: 'Brush', description: 'dont test me', unit_price: 12, merchant_id: @m1.id)
  ...
  it 'should display the total revenue the invoice will generate' do
    ...
    expect(page).to_not have_content("Total Revenue Before Discounts: $#{@i2.total_revenue}")
  end
  ...
  describe 'Discounts' do
    before :each do
      ...
      @discount_1 = @m1.discounts.create!(percentage_discount: 50, quantity_threshold: 10)
    end
    ...
    it 'should display the total revenue and discounted revenue' do
      visit admin_invoice_path(@i1)
      expect(page).to have_content("Total Revenue Before Discounts: $#{@i1.total_revenue}")
      expect(page).to have_content("Total Revenue After Discounts: $#{@i1.total_discounted_revenue}")
    end
  end
end
